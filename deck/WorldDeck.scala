...
object WorldDeck:
  ...
  val scenarios: Vector[Scenario] = Vector(
    ...
    shared("S41", "S33", "S33's row-subject swap, seen from the row card", tableRow, "the same edit as S33 — the row card renders the concept into its Substance"),
    shared("S42", "S34", "S34's typo fix, seen from the row card", tableRow, "the same edit as S34"),
